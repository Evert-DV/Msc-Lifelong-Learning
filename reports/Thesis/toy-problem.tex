...
The problem was implemented in Python: simulating the system response using SciPy's \texttt{lsim}, and implementing the adapter in Keras with the PyTorch backend. % TODO: cite python and packages?
...
\subsection{A case where the controller is too aggressive}
\begin{figure*}
    \centering
...
\subsection{A case where the controller is under-responsive}
