...
\todo[inline]{ref minute plots and tables}  % TODO: ref min plots and tables

\section{KOS Design and Template}\label[appendix]{app:kos-design}
The KOSs used during the experiments used the following design parameters, as related to the definition from~\Cref{subsec:kresling-origami}:
