...
Usage of the method on a constrained operational domain shows that both pretrained and online trained adapters manage to improve the performance, with a preference for the latter\todo{discuss pretrain and online difference in discussion}.  % TODO: pre vs online trained
...
An implementation of some kind of memory, or more envolved updating techniques like \emph{learning without forgetting} (LoF)\todo{cite}, could potentially allow the adapter to escape such vicious cycles.
