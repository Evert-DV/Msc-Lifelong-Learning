...
One set serving as a reference, with the Arduino receiving unadapted targets, and the second set used for testing target adaptation.
...
This metric is meant to provide a measure of the ``chaoticness'' of the robot's signal response.
